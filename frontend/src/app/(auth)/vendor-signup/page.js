    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="pro-left hidden lg:flex lg:w-[52%] flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="anim-fade-up">
            <p className="text-indigo-300 text-sm font-semibold uppercase tracking-widest mb-4">For Vendors</p>
            <h2 className="text-4xl font-bold text-white leading-[1.2] mb-5">
              Grow your rental<br />business here.
            </h2>
          ...
          <div className="mt-10 anim-float">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 w-fit">
              <p className="text-indigo-300 text-xs font-medium mb-1">Average vendor this month</p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10 bg-white">
        <div className="w-full max-w-[420px]">
          ...
          <div className="anim-fade-up">
            <div className="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-200 text-indigo-600 text-xs font-semibold px-3 py-1 rounded-full mb-3">
              🏪 Vendor Registration
            </div>
            <h1 className="text-[26px] font-bold text-slate-900 mb-1">Register as Vendor</h1>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 anim-fade-up d-2">
              <div>
            ...
            {/* Business details */}
            <div className="anim-fade-up d-3 rounded-xl border border-indigo-100 bg-indigo-50/50 p-4 space-y-3">
          ...
          <p className="text-center text-xs text-slate-400 mt-5">
            ...
            <Link href="/signup" className="text-indigo-600 font-semibold hover:underline">Customer signup</Link>
          </p>
        </div>
      </div>
    </div>
