    ...
    <div className="min-h-screen flex">
      ...
      <div className="odoo-left hidden lg:flex lg:w-[52%] flex-col justify-between p-14 overflow-hidden">
        ...
        <div className="absolute bottom-[-100px] left-[-80px] w-[320px] h-[320px] rounded-full opacity-25 blur-[70px]"
          style={{ background: '#3730a3', animation: 'glowPulse 9s ease-in-out infinite 1.5s' }} />
        ...
        <div className="relative z-10">
          <div className="au">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 rounded-full px-3.5 py-1.5 mb-6">
              ...
              <span className="text-indigo-200 text-xs font-semibold tracking-wide">Account Recovery</span>
            </div>
          ...
          <div className="mt-10 au d3">
            <div className="glass-card af2 w-fit">
              <p className="text-indigo-300 text-[10px] font-semibold uppercase tracking-wider mb-1">Response time</p>
              <p className="text-white text-2xl font-bold">&lt; 60s</p>
              <p className="text-indigo-300 text-xs mt-0.5">reset link in your inbox</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[400px]">
          ...
          {submitted ? (
            ...
            <div className="odoo-card au">
              <div className="mb-7">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={{ background: '#eef2ff', border: '1px solid #e1bee7' }}>
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: '#4f46e5' }}>
              ...
              <div className="mt-6 text-center au d3">
                <Link href="/login" className="text-sm font-semibold transition-colors" style={{ color: '#4f46e5' }}>
                  ← Back to Sign in
                </Link>
              </div>
            </div>
