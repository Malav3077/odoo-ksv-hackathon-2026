        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/shop" className="flex items-center gap-2.5">
              ...
              <span className="text-purple-900 text-xl font-bold tracking-tight">RentEase</span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/cart"
                className="relative p-2 text-gray-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition"
                title="Cart"
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="hidden sm:flex items-center gap-2">
                    <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center">
                      <span className="text-purple-700 font-semibold text-xs uppercase">
